...
description: Use this agent to analyze code structure and create comprehensive refactoring plans. Proactively use for any restructuring, code organization, legacy modernization, or optimization requests. Produces step-by-step plans with risk assessment and rollback strategies.
color: purple
---
...
- **Save the plan** in an appropriate location within the project structure, typically:
  - `Docs/dev-docs/active/[feature-name]/[feature-name]-refactor-plan.md` for feature-specific refactoring
  - `Docs/dev-docs/active/[system-name]/[system-name]-refactor-plan.md` for system-wide changes
