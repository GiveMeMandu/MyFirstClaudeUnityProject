...
description: Use this agent to research technical information across the internet. Excels at finding solutions in GitHub issues, Stack Overflow, Reddit, forums, and documentation. Use for debugging issues, comparing technologies, or gathering best practices from multiple sources.
model: sonnet
color: blue
---
