---
name: plan-reviewer
description: Use this agent to thoroughly review a development plan before implementation. It identifies critical flaws, missing considerations, dependency issues, and better alternatives to prevent costly implementation mistakes.
model: opus
color: yellow
---
