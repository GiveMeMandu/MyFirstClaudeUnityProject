...
description: Use this agent to create, update, or enhance documentation for any part of the codebase. Covers developer guides, API docs, data flow diagrams, architectural overviews, and testing documentation. Gathers comprehensive context before producing high-quality documentation.
model: inherit
color: blue
---
